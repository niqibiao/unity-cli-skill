...
ROUTE_IDS = {
    *(f"r{index:02d}" for index in range(1, 66)),
...
class RoutingEvalCoverageTests(unittest.TestCase):
    ...
    def test_route_case_ids_are_complete_and_unique(self):
        ...
        self.assertEqual(75, len(cases))
        self.assertEqual(75, len(set(case_ids)), "route case IDs must be unique")
    ...
    def test_original_primary_cases_cover_current_registry_and_denies(self):
        ...
        self.assertEqual(65, len(primary_cases))
        self.assertEqual(
