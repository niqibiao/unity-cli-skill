...
`SKILL.md`. Built-in discovery must use the relevant domain/tier filters from
`references/commands.md`; do not load the full command registry merely to decide
whether to search snippets.
...
fallback code only; see `references/commands.md` for structured discovery and
